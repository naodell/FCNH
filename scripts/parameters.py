...
styleDict['ttbar_had']          = (0, r.kBlue+3, 1, 1, 't#bar{t} (had)')
styleDict['ttbar_lep']          = (0, r.kBlue+5, 1, 1, 't#bar{t} (lep)')
...
scaleDict['2011']['ttbar_had']          = 165*30*70
scaleDict['2011']['ttbar_lep']          = 165*30*30
...
scaleDict['2012']['ttbar_had']          = 234*30*70
scaleDict['2012']['ttbar_lep']          = 234*30*30
...
systDict['3l_inclusive']['Fakes_mu']    =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
systDict['3l_inclusive']['Fakes_e']     =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
...
systDict['3l_eee']['Fakes_e']           =  [0.,     0.005,  0.04,  0.,     0.015,  0.20,  0.01]
...
systDict['3l_emumu']['Fakes_e']         =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
