...
systDict['ss_inclusive']['muFakes']     =  [0.,     0.005,  0.04,  0.014,  0.015,  0.,    0.30,  0.01]
systDict['ss_inclusive']['eFakes']      =  [0.,     0.005,  0.04,  0.014,  0.015,  0.,    0.30,  0.01]
systDict['ss_inclusive']['llFakes']     =  [0.,     0.005,  0.04,  0.014,  0.015,  0.,    0.30,  0.01]
...
systDict['ss_ee']['eFakes']             =  [0.,     0.005,  0.04,  0.,     0.015,  0.,    0.30,  0.01]
systDict['ss_ee']['llFakes']            =  [0.,     0.005,  0.04,  0.,     0.015,  0.,    0.30,  0.01]
systDict['ss_ee']['QFlips']             =  [0.,     0.005,  0.04,  0.,     0.015,  0.01,  0.,    0.01]
systDict['ss_emu']['Irreducible']       =  [0.026,  0.005,  0.04,  0.014,  0.015,  0.,    0.,    0.01]
systDict['ss_emu']['muFakes']           =  [0.,     0.005,  0.04,  0.014,  0.015,  0.,    0.30,  0.01]
systDict['ss_emu']['eFakes']            =  [0.,     0.005,  0.04,  0.014,  0.015,  0.,    0.30,  0.01]
systDict['ss_emu']['llFakes']           =  [0.,     0.005,  0.04,  0.014,  0.015,  0.,    0.30,  0.01]
...
systDict['ss_mumu']['muFakes']          =  [0.,     0.005,  0.04,  0.014,  0.,     0.,    0.30,  0.01]
systDict['ss_mumu']['eFakes']           =  [0.,     0.005,  0.04,  0.014,  0.,     0.,    0.,    0.01]
systDict['ss_mumu']['llFakes']          =  [0.,     0.005,  0.04,  0.014,  0.,     0.,    0.30,  0.01]
