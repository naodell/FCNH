...
systDict['ss_inclusive']['QFlips']      =  [0.,     0.005,  0.04,  0.014,  0.015,  0.2,   0.,    0.01]
systDict['ss_ee']['Irreducible']        =  [0.026,  0.005,  0.04,  0.,     0.015,  0.,    0.,    0.01]
systDict['ss_ee']['muFakes']            =  [0.,     0.005,  0.00,  0.,     0.015,  0.,    0.,    0.01]
systDict['ss_ee']['eFakes']             =  [0.,     0.005,  0.00,  0.,     0.015,  0.,    0.20,  0.01]
systDict['ss_ee']['llFakes']            =  [0.,     0.005,  0.00,  0.,     0.015,  0.,    0.20,  0.01]
systDict['ss_ee']['QFlips']             =  [0.,     0.005,  0.00,  0.,     0.015,  0.2,   0.,    0.01]
...
systDict['ss_emu']['QFlips']            =  [0.,     0.005,  0.04,  0.014,  0.015,  0.2,   0.,    0.01]
...
systDict['3l_inclusive']['llFakes']     =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
...
systDict['3l_eee']['llFakes']           =  [0.,     0.005,  0.04,  0.,     0.015,  0.20,  0.01]
systDict['3l_eemu']['Irreducible']      =  [0.026,  0.005,  0.04,  0.014,  0.015,  0.,    0.01]
systDict['3l_eemu']['muFakes']          =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
systDict['3l_eemu']['eFakes']           =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
systDict['3l_eemu']['llFakes']          =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
...
systDict['3l_emumu']['llFakes']         =  [0.,     0.005,  0.04,  0.014,  0.015,  0.20,  0.01]
systDict['3l_mumumu']['Irreducible']    =  [0.026,  0.005,  0.04,  0.014,  0.015,  0.,    0.01]
systDict['3l_mumumu']['muFakes']        =  [0.,     0.005,  0.04,  0.014,  0.,     0.20,  0.01]
systDict['3l_mumumu']['eFakes']         =  [0.,     0.005,  0.04,  0.014,  0.,     0.,    0.01]
systDict['3l_mumumu']['llFakes']        =  [0.,     0.005,  0.04,  0.014,  0.,     0.20,  0.01]
