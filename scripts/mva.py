...
def doBDT(inFile, batch, selection, flCat):
        ...
        factory.PrepareTrainingAndTestTree(r.TCut(flavorCuts[selection][flCat]), r.TCut(flavorCuts[selection][flCat]), "nTrain_Signal=0:nTrain_Background=0:SplitMode=Random:NormMode=NumEvents:!V" )

        if 'BDT' in methods:
            factory.BookMethod(r.TMVA.Types.kBDT, "BDT", "!H:!V:NTrees=200:nEventsMin=150:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=SDivSqrtSPlusB:nCuts=20:PruneMethod=NoPruning" )
...
if __name__ == '__main__':
    ...
    flavorCuts = {}
    flavorCuts['3l']  = {'inclusive': '', 'eee':'flavorCat == 5', 'eemu':'flavorCat == 6 || flavorCat == 7 || flavorCat == 9', 'emumu':'flavorCat == 8 || flavorCat == 10 || flavorCat == 11', 'mumumu':'flavorCat == 12'}
    flavorCuts['SS'] = {'inclusive': '', 'ee':'flavorCat == 1', 'emu':'flavorCat == 2 || flavorCat == 3', 'mumu':'flavorCat == 4'}
    ...
    doBDT(inFile, batch, selection, flCat)

    #for selection in selections:
    #    for flCat in flCats[selection]:
    #        doBDT(inFile, batch, selection, flCat)
