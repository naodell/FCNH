...
if period == '2012':
    ...
    signal.extend([
        ...
        cfg('FCNHUp_M125_tHj', '{0}/FCNHUpToWW_semileptonic_Plus'.format(signalDir), 1, 'FCNHUp_M125_tbar mc 2012'),
        cfg('FCNHUp_M125_TauTau_Plus', '{0}/FCNHUpToTauTau_Plus'.format(signalDir), 1, 'FCNHUp_TauTau_tbar mc 2012'),
        cfg('FCNHUp_M125_ZZ_Plus', '{0}/FCNHUpToZZ_Plus'.format(signalDir), 1, 'FCNHUp_ZZ_tbar mc 2012'),
        ])
