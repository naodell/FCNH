...
if period == '2012':
    data.extend([
        ...
        #cfg('muEG_2012C', inputDir+'/nuTuples_v7_4_a/MuEG_Run2012C', 20, 'DATA_MUEG muEG 2012'),
        #cfg('muEG_2012D', inputDir+'/nuTuples_v7_4_a/MuEG_Run2012D', 25, 'DATA_MUEG muEG 2012')
        ])
