...
if period == '2012':
    data.extend([
        ...
        cfg('muon_2012B', inputDir+'/nuTuples_v7_4/DoubleMu_Run2012B', 20, 'DATA_MUON muon 2012'),
        cfg('muon_2012C', inputDir+'/nuTuples_v7_4/DoubleMu_Run2012C', 20, 'DATA_MUON muon 2012'),
        cfg('muon_2012D', inputDir+'/nuTuples_v7_4/DoubleMu_Run2012D', 25, 'DATA_MUON muon 2012'),

        cfg('electron_2012A', inputDir+'/nuTuples_v7_4/DoubleElectron_Run2012A', 10, 'DATA_ELECTRON electron 2012'),
        cfg('electron_2012B', inputDir+'/nuTuples_v7_4/DoubleElectron_Run2012B', 20, 'DATA_ELECTRON electron 2012'),
        cfg('electron_2012C', inputDir+'/nuTuples_v7_4/DoubleElectron_Run2012C', 20, 'DATA_ELECTRON electron 2012'),
        cfg('electron_2012D', inputDir+'/nuTuples_v7_4/DoubleElectron_Run2012D', 25, 'DATA_ELECTRON electron 2012'),
    ...
    bg.extend([
        cfg('ZJets_M-50', inputDir+'/nuTuples_v7_4/DYJets', 40, 'ZJets_M-50 muon 2012'),
        cfg('ZJets_M-10To50', inputDir+'/nuTuples_v7_4/DYJets_M-10To50', 15, 'ZJets_M-10To50 muon 2012'),
