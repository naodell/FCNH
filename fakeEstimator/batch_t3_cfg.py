...
if period == '2012':
    ...
    bg.extend([
        cfg('ZJets_M-50',      '{0}/DYJetsToLL_M-50'.format(mcDir),            30,  'ZJets_M-50      muon  2012'),
        cfg('ZJets_M-10To50',  '{0}/DYJetsToLL_M-10To50filter'.format(mcDir),  10,  'ZJets_M-10To50  muon  2012'),
        ...
        cfg('WZJets3LNu',      '{0}/WZJetsTo3LNu'.format(mcDir),     5,   'WZJets3LNu      muon  2012'),
        cfg('WWJets2L2Nu',     '{0}/WWJetsTo2L2Nu'.format(mcDir),    5,   'WWJets2L2Nu     muon  2012'),
        cfg('ZZJets2L2Nu',     '{0}/ZZJetsTo2L2Nu'.format(mcDir),    5,   'ZZJets2L2Nu     muon  2012'),
        cfg('ZZTo4e',          '{0}/ZZTo4e'.format(mcDir),           5,   'ZZ4e            muon  2012'),
        cfg('ZZTo4mu',         '{0}/ZZTo4mu'.format(mcDir),          5,   'ZZ4mu           muon  2012'),
        cfg('ZZTo4tau',        '{0}/ZZTo4tau'.format(mcDir),         5,   'ZZ4tau          muon  2012'),
        cfg('ZZTo2e2mu',       '{0}/ZZTo2e2mu'.format(mcDir),        5,   'ZZ2e2mu         muon  2012'),
        cfg('ZZTo2e2tau',      '{0}/ZZTo2e2tau'.format(mcDir),       5,   'ZZ2e2tau        muon  2012'),
        cfg('ZZTo2mu2tau',     '{0}/ZZTo2mu2tau'.format(mcDir),      5,   'ZZ2mu2tau       muon  2012')
    ])
